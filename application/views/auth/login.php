...
<body id="page-top">
  ...
  <div class="container">
    <div class="card card-login mx-auto" style="width: 35rem; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19); margin-top: 10.5%;">
      ...
      <div class="card-body">
        <div style="padding-top: 15px;">
          <form id="login-form" method="post" action="<?php echo base_url('auth/login'); ?>">
            ...
            <button class="btn btn-block" type="submit" name="submit" value="login" style="margin-top: 20px; margin-bottom: 30px; background-color: #438F81;">Login</button>
          </form>
          <div class="text-left">
